...
class Switch:
    ...
    def __get__(self, instance: ActorProcess, owner=None):
    ...
    def __call__(self, actor: ActorProcess, sender: Address, message: Message):
...
class OnReceive:
    ...
    if TYPE_CHECKING:
        @staticmethod
        def __call__(actor: ActorProcess, sender: Address, message: Message):
            pass
    else:
